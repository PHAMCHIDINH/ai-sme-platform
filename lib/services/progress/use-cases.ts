import { canCompleteProject, canEvaluateCompletedProject, canMutateProgress, canSubmitDeliverable } from "@/lib/domain/lifecycle-rules";
import { findProjectForStudentEvaluation, findOwnedProjectWithProgress, updateProjectStatus, withProjectTransaction } from "@/lib/repos/project-repo";
import {
  createStudentToSmeEvaluation,
  findProgressByIdWithProject,
  findStudentProfileByUserId,
  updateProgressById,
  updateProgressByProjectId,
} from "@/lib/repos/progress-repo";
import { MilestoneItem, ProgressUpdateItem, parseMilestones, parseProgressUpdates } from "@/lib/services/progress/parser";
